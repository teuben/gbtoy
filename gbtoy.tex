...
spectrum is a 1-dimensional array\footnote{to already confuse the
  reader, some spectra of length N are viewed multi-dimensional, and
  become (N/2, 2, 1, 1)}. Each spectrum has meta-data that describe
...
\item
  EDGE survey data via Tony Wong NGC2347.fits in ``keep'' format, raw to come [2016]
\item
